<?php $__env->startSection('title','Buat Permintaan Pengadaan'); ?>
<?php $__env->startSection('page-title','Permintaan Pengadaan ATK'); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('procurement.requests.index')); ?>" class="text-decoration-none">Permintaan Saya</a></li>
...
<form id="procurementForm" method="POST" action="<?php echo e(route('procurement.requests.store')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" name="purpose"
                           class="form-control form-control-sm <?php $__errorArgs = ['purpose'];
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('purpose', $defaultPurpose)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm bg-light" value="<?php echo e(auth()->user()->department?->name ?? '-'); ?>" disabled readonly>
                ...
                <div class="mb-0">
                    ...
                    <input type="file" id="attachmentInput" name="attachments[]" class="form-control form-control-sm <?php $__errorArgs = ['attachments.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
async function loadCatalog() {
    const [itemsRes, catsRes] = await Promise.all([
        fetch('<?php echo e(route("procurement.items.search")); ?>'),
        fetch('<?php echo e(route("procurement.items.categories")); ?>')
    ]);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/warehouse/resources/views/procurement/requests/create.blade.php ENDPATH**/ ?>